function [K, runtime, out] = svm_theta_kernel_subgraph_l(Gs, opt)
...
if(~strcmp(opt.sampling_scheme,'convergence'))
    nSamplesPer = sample_weights(opt.subgraph_samples, [mind, maxd], ns, opt.sampling_weights);
end
...
sample_labels = cell(N,opt.subgraph_samples);
